...
sleep 5s
gnome-terminal --execute bash -c "source ~/carla-ros-bridge/catkin_ws/devel/setup.bash; roslaunch ego_vehicle ego_vehicle.launch spawn_point:='50.0, -7.45, 0.0, 0.0, 0.0, 180.0'"
sleep 2s
...
sleep 2s
gnome-terminal --execute bash -c "python scenario_all_random.py -n 250"
